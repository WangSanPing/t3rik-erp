...
import com.t3rik.system.mapper.SysMenuMapper;
import com.t3rik.system.mapper.SysRoleMapper;
import com.t3rik.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements ISysMenuService {
    ...
    public List<SysMenu> selectMenuTreeByUserId(Long userId) {
        // 默认只查询后台管理的菜单
        List<SysMenu> menus = this.selectMenuTreeByUserIdAndModuleType(userId, ModuleTypeEnum.MANAGER_SYSTEM);
     ...
     */
    @Override
    public List<SysMenu> selectMenuTreeByUserIdAndModuleType(Long userId, ModuleTypeEnum moduleTypeEnum) {
        ...
        // 根据传入的不同类型查询
        menus = menus.stream()
                .filter(menu -> moduleTypeEnum.getCode().equals(menu.getModuleType())).toList();
        return menus;
    }
