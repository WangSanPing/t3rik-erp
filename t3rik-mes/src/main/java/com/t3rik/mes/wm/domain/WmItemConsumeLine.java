...
public class WmItemConsumeLine extends BaseEntity
{
    ...
    /** 消耗数量 */
    @Excel(name = "消耗数量")
    private BigDecimal quantityConsume;
    ...
    public void setQuantityConsume(BigDecimal quantityConsume) 
    {
        this.quantityConsume = quantityConsume;
    }

    public BigDecimal getQuantityConsume() 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("quantityConsume", getQuantityConsume())
