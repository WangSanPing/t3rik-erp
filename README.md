...
t3rik-erp项目是一个聚焦于制造执行系统（MES）和人力资源管理（HRM）的开源平台，现已逐步扩展为具备完整业务链的轻量级 ERP 系统。项目同时配套开发了支持移动办公的小程序端，便于员工在生产、考勤、审批等场景下移动使用。旨在解决中小企业在人力、物料、销售、生产制造等方面的信息化建设需求。该系统为中小企业提供了全面的信息化解决方案，帮助企业优化资源配置、提升生产效率，从而实现更高效、更智能的运营。
