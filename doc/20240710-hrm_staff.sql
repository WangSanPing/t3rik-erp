...
(
    ...
    staff_status tinyint(2) default 0 comment '状态（0-备选，1-面试，2-面试通过，3-入职申请，4-入职通过）'
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='员工花名册表';
