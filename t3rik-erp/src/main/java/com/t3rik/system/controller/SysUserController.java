...
public class SysUserController extends BaseController {
    ...
    public AjaxResult edit(@Validated @RequestBody SysUser user) {
        if (user.getUserId().equals(Long.valueOf(DefaultDataEnum.ADMIN.getCode()))) {
            return error(MsgConstants.NOT_ALLOW_OPT_ADMIN);
        }
    ...
    public AjaxResult remove(@PathVariable Long[] userIds) {
        if (ArrayUtils.contains(userIds, Long.valueOf(DefaultDataEnum.ADMIN.getCode()))) {
            return error(MsgConstants.NOT_ALLOW_OPT_ADMIN);
        }
